"""
QuickLoan package -- Session 1: Basic Conversational Agent (US-01)
==================================================================

This file runs automatically when Python imports the quickloan package.
...
#   load_dotenv()
#
# Why here? This file is the first thing imported when `quickloan` loads,
